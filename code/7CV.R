...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/7/demog")
wd<- paste0(Datasets,"/7/demog.sas7bdat")
...
write.csv(base,"./cvresults/7-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/7/measur")
wd<- paste0(Datasets,"/7/measur.sas7bdat")
...
write.csv(PTumorch, "./cvresults/7-FullTumorSz.csv")
...
write.csv(TumorSzfinal, "./cvresults/7-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/7-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model7")
write.csv(a,"./val_v3/7.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/7-pca3.csv")
# ========================================================================
...
a<- matrix(a)
colnames(a)<-paste0("model7")
write.csv(a,"./val_v4/7.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/7-pca4.csv")
# =========================================================================
# Overall survival
# ========================================================================= 
...
write.csv(os, "./cvresults/7-os.csv")
os$event<- as.numeric(os$event)
...
# ================================================================= 
filename0=paste0(Datasets,"/7/resples")
wd<- paste0(Datasets,"/7/resples.sas7bdat")
...
write.csv(BestRespf, "./cvresults/7-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/7-base.csv")
os<-read.csv("./cvresults/7-os.csv")
BestResp<-read.csv("./cvresults/7-BestResp.csv")
pca3<-read.csv("./cvresults/7-pca3.csv")
pca4<-read.csv("./cvresults/7-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata,"./cvresults/7-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata,"./cvresults/7-alldata7.csv")
alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]


write.csv(alldata, "./cvresults/7-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( bestcut,  "./cvresults/7-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/7-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/7-PCA2_conf_matrix.csv")
...
write.table(bestcut, "./cvresults/7bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/7Intercept_V3.csv")
write.table(coef_sex, "./cvresults/7SEX_V3.csv")
write.table(coef_age, "./cvresults/7AGE_V3.csv")
write.table(coef_pc1, "./cvresults/7PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/7PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/7misclassificationrate_V3.csv")
write.table(auc, "./cvresults/7auc_V3.csv")
write.table(sensitivity, "./cvresults/7sensitivity_V3.csv")
write.table(specificity, "./cvresults/7specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( bestcut,  "./cvresults/7-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/7-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/7-PCA3_conf_matrix.csv")
...
write.table(bestcut, "./cvresults/7bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/7Intercept_V4.csv")
write.table(coef_sex, "./cvresults/7SEX_V4.csv")
write.table(coef_age, "./cvresults/7AGE_V4.csv")
write.table(coef_pc1, "./cvresults/7PC1_V4.csv")
write.table(coef_pc2, "./cvresults/7PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/7PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/7misclassificationrate_V4.csv")
write.table(auc, "./cvresults/7auc_V4.csv")
write.table(sensitivity, "./cvresults/7sensitivity_V4.csv")
write.table(specificity, "./cvresults/7specificity_V4.csv")
# ===========================================================================================