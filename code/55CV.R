...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/55/upat")
wd<- paste0(Datasets,"/55/upat.sas7bdat")
...
write.csv(base,"./cvresults/55-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/55/uta")
wd<- paste0(Datasets,"/55/uta.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


TumorSz <- data.frame( USUBJID=dtr$RUSUBJID, val=dtr$TAMSUM, visitN = dtr$CYCLE)
...
write.csv(PTumorch, "./cvresults/55-FullTumorSz.csv")
...
write.csv(TumorSzfinal, "./cvresults/55-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/55-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model55")
write.csv(a,"./val_v3/55.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/55-pca3.csv")
# ========================================================================
...
a<- matrix(a)
colnames(a)<-paste0("model55")
write.csv(a,"./val_v4/55.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/55-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/55-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/55/ueffic")
wd<- paste0(Datasets,"/55/ueffic.sas7bdat")
adrs<- assign(filename0, read_sas(wd))


BestResp <- (data.frame(USUBJID=adrs$RUSUBJID, BORval=adrs$BOVRPPA))



BestResp["BORval"][BestResp["BORval"]=="COMPLETE RESPONSE"]<-"1"
BestResp["BORval"][BestResp["BORval"]=="PARTIAL RESPONSE"]<-"1"
BestResp["BORval"][BestResp["BORval"]=="NO CHANGE/STABLE DISEASE"]<-"0"
...
write.csv(BestRespf, "./cvresults/55-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/55-base.csv")
os<-read.csv("./cvresults/55-os.csv")
BestResp<-read.csv("./cvresults/55-BestResp.csv")
pca3<-read.csv("./cvresults/55-pca3.csv")
pca4<-read.csv("./cvresults/55-pca4.csv")
...
write.csv(alldata, "./cvresults/55-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata, "./cvresults/55-alldata55.csv")
alldata <- merge(os, alldata, by="USUBJID")


write.csv(alldata, "./cvresults/55-alldata.csv")

# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/55-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/55-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/55-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/55-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/55bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/55Intercept_V3.csv")
write.table(coef_sex, "./cvresults/55SEX_V3.csv")
write.table(coef_age, "./cvresults/55AGE_V3.csv")
write.table(coef_pc1, "./cvresults/55PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/55PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/55misclassificationrate_V3.csv")
write.table(auc, "./cvresults/55auc_V3.csv")
write.table(sensitivity, "./cvresults/55sensitivity_V3.csv")
write.table(specificity, "./cvresults/55specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/55-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/55-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/55-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/55bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/55Intercept_V4.csv")
write.table(coef_sex, "./cvresults/55SEX_V4.csv")
write.table(coef_age, "./cvresults/55AGE_V4.csv")
write.table(coef_pc1, "./cvresults/55PC1_V4.csv")
write.table(coef_pc2, "./cvresults/55PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/55PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/55misclassificationrate_V4.csv")
write.table(auc, "./cvresults/55auc_V4.csv")
write.table(sensitivity, "./cvresults/55sensitivity_V4.csv")
write.table(specificity, "./cvresults/55specificity_V4.csv")
# ====================================================================================