...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/8/dm")
wd<- paste0(Datasets,"/8/dm.sas7bdat")
dm<- assign(filename0, read_sas(wd))


base <- unique(dm[,c("RUSUBJID" , "SEX", "AGEC")])
...
write.csv(base,"./cvresults/8-base.csv")

# ==========================================================================
# Actual Tumor Size
# ========================================================================== 
filename0=paste0(Datasets,"/8/ls")
wd<- paste0(Datasets,"/8/ls.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


idx2<- dtr$LSTESTCD =="LENGTH"
TumorSz <- data.frame( USUBJID=dtr$RUSUBJID[idx2], val=dtr$LSSTRESN[idx2], visitN = dtr$VISITNUM[idx2])
...
write.csv(PTumorch, "./cvresults/8-FullTumorSz.csv")
...
write.csv(TumorSzfinal, "./cvresults/8-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/8-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model8")
write.csv(a,"./val_v3/8.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/8-pca3.csv")
# ========================================================================
...
a<- matrix(a)
colnames(a)<-paste0("model8")
write.csv(a,"./val_v4/8.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/8-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/8-os.csv")
# =================================================================
...
write.csv(BestRespf, "./cvresults/8-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/8-base.csv")
os<-read.csv("./cvresults/8-os.csv")
BestResp<-read.csv("./cvresults/8-BestResp.csv")
pca3<-read.csv("./cvresults/8-pca3.csv")
pca4<-read.csv("./cvresults/8-pca4.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/8-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/8-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/8-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/8bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/8Intercept_V3.csv")
write.table(coef_sex, "./cvresults/8SEX_V3.csv")
write.table(coef_age, "./cvresults/8AGE_V3.csv")
write.table(coef_pc1, "./cvresults/8PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/8PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/8misclassificationrate_V3.csv")
write.table(auc, "./cvresults/8auc_V3.csv")
write.table(sensitivity, "./cvresults/8sensitivity_V3.csv")
write.table(specificity, "./cvresults/8specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/8-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/8-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/8-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/8bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/8Intercept_V4.csv")
write.table(coef_sex, "./cvresults/8SEX_V4.csv")
write.table(coef_age, "./cvresults/8AGE_V4.csv")
write.table(coef_pc1, "./cvresults/8PC1_V4.csv")
write.table(coef_pc2, "./cvresults/8PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/8PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/8misclassificationrate_V4.csv")
write.table(auc, "./cvresults/8auc_V4.csv")
write.table(sensitivity, "./cvresults/8sensitivity_V4.csv")
write.table(specificity, "./cvresults/8specificity_V4.csv")
# ==============================================================================