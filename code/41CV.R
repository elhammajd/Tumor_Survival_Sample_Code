...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/41/corevar")
wd<- paste0(Datasets,"/41/corevar.sas7bdat")
...
write.csv(base,"./cvresults/41-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/41/lesion")
wd<- paste0(Datasets,"/41/lesion.sas7bdat")
...
PTumorch<- data.frame(USUBJID=TumorSz$USUBJID, val.W12 =TumorSz$val.W12 , TumorCh)
PTumorch[PTumorch == "Inf"] <- NA
PTumorch<- na.omit(PTumorch)

write.csv(PTumorch, "./cvresults/41-FullTumorSz.csv")


keeps <- c("USUBJID","val.W18","val.W24","val.W36")

TumorSzfinal =PTumorch[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.W18"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.W24"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.W36"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/41-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/41-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model41")
write.csv(a,"./val_v3/41.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/41-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model41")
write.csv(a,"./val_v4/41.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/41-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/41-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/41/respeval")
wd<- paste0(Datasets,"/41/respeval.sas7bdat")
adrs<- assign(filename0, read_sas(wd))


BestResp <- unique(data.frame(USUBJID=adrs$SUBJID, BORval=adrs$RSBOR))
...
write.csv(BestResp, "./cvresults/41-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/41-base.csv")
os<-read.csv("./cvresults/41-os.csv")
BestResp<-read.csv("./cvresults/41-BestResp.csv")
pca3<-read.csv("./cvresults/41-pca3.csv")
pca4<-read.csv("./cvresults/41-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata, "./cvresults/41-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata, "./cvresults/41-alldata41.csv")
alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]


write.csv(alldata, "./cvresults/41-alldata.csv")

# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/41-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/41-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/41-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/41-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/41bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/41Intercept_V3.csv")
write.table(coef_sex, "./cvresults/41SEX_V3.csv")
write.table(coef_age, "./cvresults/41AGE_V3.csv")
write.table(coef_pc1, "./cvresults/41PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/41PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/41misclassificationrate_V3.csv")
write.table(auc, "./cvresults/41auc_V3.csv")
write.table(sensitivity, "./cvresults/41sensitivity_V3.csv")
write.table(specificity, "./cvresults/41specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/41-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/41-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/41-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/41bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/41Intercept_V4.csv")
write.table(coef_sex, "./cvresults/41SEX_V4.csv")
write.table(coef_age, "./cvresults/41AGE_V4.csv")
write.table(coef_pc1, "./cvresults/41PC1_V4.csv")
write.table(coef_pc2, "./cvresults/41PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/41PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/41misclassificationrate_V4.csv")
write.table(auc, "./cvresults/41auc_V4.csv")
write.table(sensitivity, "./cvresults/41sensitivity_V4.csv")
write.table(specificity, "./cvresults/41specificity_V4.csv")
# =====================================================================================