...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/9/dm")
wd<- paste0(Datasets,"/9/dm.sas7bdat")
...
write.csv(base,"./cvresults/9-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/9/ls")
wd<- paste0(Datasets,"/9/ls.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


idx<- dtr$LSTESTCD =="LENGTH"
TumorSz <- data.frame( USUBJID=dtr$RUSUBJID[idx], val=dtr$LSSTRESN[idx], visitN = dtr$VISITNUM[idx])
...
write.csv(PTumorch, "./cvresults/9-FullTumorSz.csv")


keeps <- c("USUBJID","val.2","val.4","val.6")

TumorSzfinal =PTumorch[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.2"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.4"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.6"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/9-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/9-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model9")
write.csv(a,"./val_v3/9.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/9-pca3.csv")
# ========================================================================
...
a<- matrix(a)
colnames(a)<-paste0("model9")
write.csv(a,"./val_v4/9.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/9-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/9-os.csv")
...
BestResp <- (data.frame(USUBJID=adrs$RUSUBJID[idx], BORval=adrs$LSSTRESC[idx]))
...
write.csv(BestRespf, "./cvresults/9-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/9-base.csv")
os<-read.csv("./cvresults/9-os.csv")
BestResp<-read.csv("./cvresults/9-BestResp.csv")
pca3<-read.csv("./cvresults/9-pca3.csv")
pca4<-read.csv("./cvresults/9-pca4.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/9-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/9-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/9-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/9bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/9Intercept_V3.csv")
write.table(coef_sex, "./cvresults/9SEX_V3.csv")
write.table(coef_age, "./cvresults/9AGE_V3.csv")
write.table(coef_pc1, "./cvresults/9PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/9PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/9misclassificationrate_V3.csv")
write.table(auc, "./cvresults/9auc_V3.csv")
write.table(sensitivity, "./cvresults/9sensitivity_V3.csv")
write.table(specificity, "./cvresults/9specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/9-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/9-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/9-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/9bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/9Intercept_V4.csv")
write.table(coef_sex, "./cvresults/9SEX_V4.csv")
write.table(coef_age, "./cvresults/9AGE_V4.csv")
write.table(coef_pc1, "./cvresults/9PC1_V4.csv")
write.table(coef_pc2, "./cvresults/9PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/9PCAV3Prediction.csv")
write.table(misclassificationrate, "./cvresults/9misclassificationrate_V4.csv")
write.table(auc, "./cvresults/9auc_V4.csv")
write.table(sensitivity, "./cvresults/9sensitivity_V4.csv")
write.table(specificity, "./cvresults/9specificity_V4.csv")
# ============================================================================================