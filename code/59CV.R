...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/59/adsl")
wd<- paste0(Datasets,"/59/adsl.sas7bdat")
...
write.csv(base,"./cvresults/59-base.csv")
# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/59/advs")
wd<- paste0(Datasets,"/59/advs.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


TumorSz <- data.frame( USUBJID=dtr$USUBJID, val=dtr$CHG, visitN = dtr$AVISITN)
...
BASE<- dtr$BASE
TumorCh<- ((TumorSz[2:ncol(TumorSz)]-BASE)/ BASE)*100  
...
write.csv(PTumorch, "./cvresults/59-FullTumorSz.csv")


keeps <- c("USUBJID","val.1.1","val.1.8","val.2.1")

TumorSzfinal =PTumorch[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.1.1"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.1.8"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.2.1"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/59-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/59-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model59")
write.csv(a,"./val_v3/59.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/59-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model59")
write.csv(a,"./val_v4/59.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/59-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/59-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/59/adresp")
wd<- paste0(Datasets,"/59/adresp.sas7bdat")
adrs<- assign(filename0, read_sas(wd))


idx<- adrs$PARAMCD =="OVRLRESP" 
BestResp <- (data.frame(USUBJID=adrs$USUBJID[idx], BORval=adrs$AVALC[idx]))
...
write.csv(BestRespf, "./cvresults/59-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/59-base.csv")
os<-read.csv("./cvresults/59-os.csv")
BestResp<-read.csv("./cvresults/59-BestResp.csv")
pca3<-read.csv("./cvresults/59-pca3.csv")
pca4<-read.csv("./cvresults/59-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata, "./cvresults/59-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata, "./cvresults/59-alldata59.csv")
alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]

write.csv(alldata, "./cvresults/59-alldata.csv")
# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/59-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/59-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/59-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/59-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/59bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/59Intercept_V3.csv")
write.table(coef_sex, "./cvresults/59SEX_V3.csv")
write.table(coef_age, "./cvresults/59AGE_V3.csv")
write.table(coef_pc1, "./cvresults/59PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/59PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/59misclassificationrate_V3.csv")
write.table(auc, "./cvresults/59auc_V3.csv")
write.table(sensitivity, "./cvresults/59sensitivity_V3.csv")
write.table(specificity, "./cvresults/59specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/59-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/59-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/59-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/59bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/59Intercept_V4.csv")
write.table(coef_sex, "./cvresults/59SEX_V4.csv")
write.table(coef_age, "./cvresults/59AGE_V4.csv")
write.table(coef_pc1, "./cvresults/59PC1_V4.csv")
write.table(coef_pc2, "./cvresults/59PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/59PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/59misclassificationrate_V4.csv")
write.table(auc, "./cvresults/59auc_V4.csv")
write.table(sensitivity, "./cvresults/59sensitivity_V4.csv")
write.table(specificity, "./cvresults/59specificity_V4.csv")
# ==================================================================================================