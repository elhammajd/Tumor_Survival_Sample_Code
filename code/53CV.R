...
write.csv(base,"./cvresults/53-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/53/adls_pds2019")
wd<- paste0(Datasets,"/53/adls_pds2019.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


TumorSz <- data.frame( USUBJID=dtr$SUBJID, val=dtr$LSSLD, visitN = dtr$VISIT)
...
TumorCh<- ((TumorSz[2:ncol(TumorSz)]-TumorSz[,4])/ TumorSz[,4])*100  
...
write.csv(PTumorch, "./cvresults/53-FullTumorSz.csv")


keeps <- c("USUBJID", "val.Week.8","val.Week.12","val.Week.16")

TumorSzfinal =PTumorch[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.Week.8"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.Week.12"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.Week.16"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/53-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/53-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model53")
write.csv(a,"./val_v3/53.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/53-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model53")
write.csv(a,"./val_v4/53.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/53-pca4.csv")
# ================================================================
# Overall survival
# ================================================================
filename0=paste0(Datasets,"/53/adsl_pds2019")
...
write.csv(os,"./cvresults/53-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/53/adrsp_pds2019")
wd<- paste0(Datasets,"/53/adrsp_pds2019.sas7bdat")
adrs<- assign(filename0, read_sas(wd))


BestResp <- (data.frame(USUBJID=adrs$SUBJID, BORval=adrs$RSTRESP))
...
BestResp["BORval"][BestResp["BORval"]=="Not applicable"]<-NA
BestResp["BORval"][BestResp["BORval"]=="Unknown"]<-NA
BestResp["BORval"][BestResp["BORval"]=="Not done"]<-NA
...
write.csv(BestRespf, "./cvresults/53-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/53-base.csv")
os<-read.csv("./cvresults/53-os.csv")
BestResp<-read.csv("./cvresults/53-BestResp.csv")
pca3<-read.csv("./cvresults/53-pca3.csv")
pca4<-read.csv("./cvresults/53-pca4.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/53-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/53-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/53-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/53bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/53Intercept_V3.csv")
write.table(coef_sex, "./cvresults/53SEX_V3.csv")
write.table(coef_age, "./cvresults/53AGE_V3.csv")
write.table(coef_pc1, "./cvresults/53PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/53PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/53misclassificationrate_V3.csv")
write.table(auc, "./cvresults/53auc_V3.csv")
write.table(sensitivity, "./cvresults/53sensitivity_V3.csv")
write.table(specificity, "./cvresults/53specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/53-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/53-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/53-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/53bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/53Intercept_V4.csv")
write.table(coef_sex, "./cvresults/53SEX_V4.csv")
write.table(coef_age, "./cvresults/53AGE_V4.csv")
write.table(coef_pc1, "./cvresults/53PC1_V4.csv")
write.table(coef_pc2, "./cvresults/53PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/53PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/53misclassificationrate_V4.csv")
write.table(auc, "./cvresults/53auc_V4.csv")
write.table(sensitivity, "./cvresults/53sensitivity_V4.csv")
write.table(specificity, "./cvresults/53specificity_V4.csv")
# =====================================================================================