...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/23/adsl")
wd<- paste0(Datasets,"/23/adsl.sas7bdat")
dm<- assign(filename0, read_sas(wd))


base <- unique(dm[,c("USUBJID" , "SEX", "AGEGR1N")])
...
write.csv(base,"./cvresults/23-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/23/adtr")
wd<- paste0(Datasets,"/23/adtr.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


TumorSz <- data.frame( USUBJID=dtr$USUBJID, val=dtr$PCHG , visitN = dtr$VISITNUM)
...
write.csv(TumorSz, "./cvresults/23-FullTumorSz.csv")

keeps <- c("USUBJID","val.275", "val.475", "val.675")
...
write.csv(TumorSzfinal, "./cvresults/23-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/23-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model23")
write.csv(a,"./val_v3/23.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/23-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model23")
write.csv(a,"./val_v4/23.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/23-pca4.csv")
...
write.csv(os, "./cvresults/23-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/23/adrs")
wd<- paste0(Datasets,"/23/adrs.sas7bdat")
...
write.csv(BestResp, "./cvresults/23-BestResp.csv")
# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/23-base.csv")
os<-read.csv("./cvresults/23-os.csv")
BestResp<-read.csv("./cvresults/23-BestResp.csv")
pca3<-read.csv("./cvresults/23-pca3.csv")
pca4<-read.csv("./cvresults/23-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata, "./cvresults/23-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata, "./cvresults/23-alldata23.csv")
alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]


write.csv(alldata, "./cvresults/23-alldata.csv")

# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/23-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/23-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/23-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/23-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/23bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/23Intercept_V3.csv")
write.table(coef_sex, "./cvresults/23SEX_V3.csv")
write.table(coef_age, "./cvresults/23AGE_V3.csv")
write.table(coef_pc1, "./cvresults/23PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/23PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/23misclassificationrate_V3.csv")
write.table(auc, "./cvresults/23auc_V3.csv")
write.table(sensitivity, "./cvresults/23sensitivity_V3.csv")
write.table(specificity, "./cvresults/23specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/23-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/23-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/23-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/23bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/23Intercept_V4.csv")
write.table(coef_sex, "./cvresults/23SEX_V4.csv")
write.table(coef_age, "./cvresults/23AGE_V4.csv")
write.table(coef_pc1, "./cvresults/23PC1_V4.csv")
write.table(coef_pc2, "./cvresults/23PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/23PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/23misclassificationrate_V4.csv")
write.table(auc, "./cvresults/23auc_V4.csv", append = TRUE)
write.table(sensitivity, "./cvresults/23sensitivity_V4.csv")
write.table(specificity, "./cvresults/23specificity_V4.csv")
# ==================================================================================