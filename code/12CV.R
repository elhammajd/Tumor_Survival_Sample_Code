...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/12/corevar")
wd<- paste0(Datasets,"/12/corevar.sas7bdat")
...
write.csv(base,"./cvresults/12-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/12/lesion")
wd<- paste0(Datasets,"/12/lesion.sas7bdat")
...
write.csv(PTumorch, "./cvresults/12-FullTumorSz.csv")


keeps <- c("USUBJID","val.W6","val.W12","val.W18")

TumorSzfinal =TumorSz[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.W6"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.W12"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.W18"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/12-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/12-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model12")
write.csv(a,"./val_v3/12.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/12-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model12")
write.csv(a,"./val_v4/12.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/12-pca4.csv")
...
write.csv(os, "./cvresults/12-os.csv")
# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/12/respeval")
wd<- paste0(Datasets,"/12/respeval.sas7bdat")
adrs<- assign(filename0, read_sas(wd))


BestResp <- (data.frame(USUBJID=adrs$SUBJID, BORval=adrs$RSRESP))
...
write.csv(BestRespf, "./cvresults/12-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/12-base.csv")
os<-read.csv("./cvresults/12-os.csv")
BestResp<-read.csv("./cvresults/12-BestResp.csv")
pca3<-read.csv("./cvresults/12-pca3.csv")
pca4<-read.csv("./cvresults/12-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata,"./cvresults/12-alldata0.csv" )
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata,"./cvresults/12-alldata12.csv" )
alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]


write.csv(alldata, "./cvresults/12-alldata.csv")

# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/12-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/12-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/12-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/12-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/12bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/12Intercept_V3.csv")
write.table(coef_sex, "./cvresults/12SEX_V3.csv")
write.table(coef_age, "./cvresults/12AGE_V3.csv")
write.table(coef_pc1, "./cvresults/12PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/12PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/12misclassificationrate_V3.csv")
write.table(auc, "./cvresults/12auc_V3.csv")
write.table(sensitivity, "./cvresults/12sensitivity_V3.csv")
write.table(specificity, "./cvresults/12specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/12-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/12-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/12-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/12bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/12Intercept_V4.csv")
write.table(coef_sex, "./cvresults/12SEX_V4.csv")
write.table(coef_age, "./cvresults/12AGE_V4.csv")
write.table(coef_pc1, "./cvresults/12PC1_V4.csv")
write.table(coef_pc2, "./cvresults/12PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/12PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/12misclassificationrate_V4.csv")
write.table(auc, "./cvresults/12auc_V4.csv")
write.table(sensitivity, "./cvresults/12sensitivity_V4.csv")
write.table(specificity, "./cvresults/12specificity_V4.csv")
# =================================================================================