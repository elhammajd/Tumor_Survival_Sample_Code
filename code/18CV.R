...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/18/dm")
wd<- paste0(Datasets,"/18/dm.sas7bdat")
dm<- assign(filename0, read_sas(wd))


base <- unique(dm[,c("USUBJID" , "SEX", "AGE")])
base$AGE<- round(base$AGE)
...
write.csv(base,"./cvresults/18-base.csv")

# ==========================================================================
# Actual Tumor Size
# ==========================================================================
filename0=paste0(Datasets,"/18/tr")
wd<- paste0(Datasets,"/18/tr.sas7bdat")
dtr<- assign(filename0, read_sas(wd))


TumorSz <- data.frame( USUBJID=dtr$USUBJID, val=dtr$PCBAS, visitN = dtr$VISITNUM)
...
write.csv(TumorSz, "./cvresults/18-FullTumorSz.csv")

keeps <- c("USUBJID","val.221", "val.231", "val.251")

TumorSzfinal =TumorSz[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.221"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.231"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.251"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/18-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/18-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model18")
write.csv(a,"./val_v3/18.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/18-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model18")
write.csv(a,"./val_v4/18.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/18-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/18-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/18/rs")
wd<- paste0(Datasets,"/18/rs.sas7bdat")
adrs<- assign(filename0, read_sas(wd))


BestResp <- unique(data.frame(USUBJID=adrs$USUBJID, BORval=adrs$BESTRESP))
...
write.csv(BestRespf, "./cvresults/18-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/18-base.csv")
os<-read.csv("./cvresults/18-os.csv")
BestResp<-read.csv("./cvresults/18-BestResp.csv")
pca3<-read.csv("./cvresults/18-pca3.csv")
pca4<-read.csv("./cvresults/18-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata, "./cvresults/18-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata, "./cvresults/18-alldata18.csv")
# alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]


write.csv(alldata, "./cvresults/18-alldata.csv")

# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/18-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/18-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/18-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/18-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/18bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/18Intercept_V3.csv")
write.table(coef_sex, "./cvresults/18SEX_V3.csv")
write.table(coef_age, "./cvresults/18AGE_V3.csv")
write.table(coef_pc1, "./cvresults/18PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/18PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/18misclassificationrate_V3.csv")
write.table(auc, "./cvresults/18auc_V3.csv")
write.table(sensitivity, "./cvresults/18sensitivity_V3.csv")
write.table(specificity, "./cvresults/18specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/18-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/18-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/18-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/18bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/18Intercept_V4.csv")
write.table(coef_sex, "./cvresults/18SEX_V4.csv")
write.table(coef_age, "./cvresults/18AGE_V4.csv")
write.table(coef_pc1, "./cvresults/18PC1_V4.csv")
write.table(coef_pc2, "./cvresults/18PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/18PCAV3Prediction_V4.csv")
write.table(misclassificationrate, "./cvresults/18misclassificationrate_V4.csv")
write.table(auc, "./cvresults/18auc_V4.csv")
write.table(sensitivity, "./cvresults/18sensitivity_V4.csv")
write.table(specificity, "./cvresults/18specificity_V4.csv")
# ===================================================================================