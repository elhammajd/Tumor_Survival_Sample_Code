...
# =========================================================================
Datasets= "./Datasets"  
filename0=paste0(Datasets,"/22/adsl")
wd<- paste0(Datasets,"/22/adsl.sas7bdat")
...
write.csv(base,"./cvresults/22-base.csv")

# ==========================================================================
# Actual Tumor Size
# ========================================================================== 
filename0=paste0(Datasets,"/22/adtr")
wd<- paste0(Datasets,"/22/adtr.sas7bdat")
...
write.csv(TumorSz, "./cvresults/22-FullTumorSz.csv")

keeps <- c("USUBJID","val.1215", "val.1415", "val.5002")

TumorSzfinal =TumorSz[keeps]
names(TumorSzfinal)[names(TumorSzfinal)=="val.1215"] <-"v2"
names(TumorSzfinal)[names(TumorSzfinal)=="val.1415"]<- "v3"
names(TumorSzfinal)[names(TumorSzfinal)=="val.5002"]<- "v4"

write.csv(TumorSzfinal, "./cvresults/22-TumorSz.csv")
# ========================================================================
# PCA MODEL
# ========================================================================
TumorSzV3<-read.csv("./cvresults/22-TumorSz.csv")
keeps <-c("v2","v3")
...
a<- matrix(a)
colnames(a)<-paste0("model22")
write.csv(a,"./val_v3/22.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit3<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit3)


write.csv(scorevisit3,"./cvresults/22-pca3.csv")
# ========================================================================
keeps <- c("v2", "v3", "v4")
...
a<- matrix(a)
colnames(a)<-paste0("model22")
write.csv(a,"./val_v4/22.csv", append = FALSE, quote = FALSE, sep = "", row.names = FALSE, col.names = TRUE)
scorevisit4<- cbind(USUBJID=TumorSzfinal$USUBJID, scorevisit4)


write.csv(scorevisit4,"./cvresults/22-pca4.csv")
# =========================================================================
# Overall survival
# =========================================================================
...
write.csv(os, "./cvresults/22-os.csv")

# =================================================================
# best overall response T=CR, T=PR, F=SD, F=PD, NE -> NA
# ================================================================= 
filename0=paste0(Datasets,"/22/adrs")
wd<- paste0(Datasets,"/22/adrs.sas7bdat")
...
write.csv(BestResp, "./cvresults/22-BestResp.csv")

# ==================================================================
# Merge all data  visits 
# ==================================================================
base<-read.csv("./cvresults/22-base.csv")
os<-read.csv("./cvresults/22-os.csv")
BestResp<-read.csv("./cvresults/22-BestResp.csv")
pca3<-read.csv("./cvresults/22-pca3.csv")
pca4<-read.csv("./cvresults/22-pca4.csv")
...
drop <- c("X.x","X.y")
write.csv(alldata, "./cvresults/22-alldata0.csv")
alldata<- merge(TumorSzfinal, alldata, by="USUBJID")
write.csv(alldata, "./cvresults/22-alldata22.csv")
alldata <- merge(os, alldata, by="USUBJID")
alldata = alldata[,!(names(alldata) %in% drop)]


write.csv(alldata, "./cvresults/22-alldata.csv")

# ============================================================================
# Prediction / Cross validation for PCA Model 3 Visits
# ============================================================================
alldata<-read.csv("./cvresults/22-alldata.csv")
...
glmnet.bin <- function(data,  idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/22-bestcut_V3.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/22-coef_V3.csv")
...
write.csv(conf_matrix, "./cvresults/22-PCA2_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/22bestcut_V3.csv")
write.table(coef_intercept, "./cvresults/22Intercept_V3.csv")
write.table(coef_sex, "./cvresults/22SEX_V3.csv")
write.table(coef_age, "./cvresults/22AGE_V3.csv")
write.table(coef_pc1, "./cvresults/22PC1_V3.csv")
write.csv(PCAV2Prediction, "./cvresults/22PCAV2Prediction_V3.csv")
write.table(misclassificationrate, "./cvresults/22misclassificationrate_V3.csv")
write.table(auc, "./cvresults/22auc_V3.csv")
write.table(sensitivity, "./cvresults/22sensitivity_V3.csv")
write.table(specificity, "./cvresults/22specificity_V3.csv")
# ============================================================================
...
glmnet.bin <- function(data, idx.tr=NULL, base.covariates= baseCov, lambda=c("lambda.min", "lambda.1se")){
  ...
  # tidy(bestcut)
  # write.csv( tidy(bestcut),  "./cvresults/22-bestcut_V4.csv")
  coef.exactt <- coef(cv.fit, s = c(lambda))
  
  # tidy(coef.exactt)
  # write.csv( tidy(coef.exactt),  "./cvresults/22-coef_V4.csv")
...
specificity<- specificity(conf_matrix)
conf_matrix<- as.numeric(conf_matrix)
write.csv(conf_matrix, "./cvresults/22-PCA3_conf_matrix.csv")
...
write.table( bestcut,  "./cvresults/22bestcut_V4.csv")
write.table(coef_intercept, "./cvresults/22Intercept_V4.csv")
write.table(coef_sex, "./cvresults/22SEX_V4.csv")
write.table(coef_age, "./cvresults/22AGE_V4.csv")
write.table(coef_pc1, "./cvresults/22PC1_V4.csv")
write.table(coef_pc2, "./cvresults/22PC2_V4.csv")
write.csv(PCAV3Prediction, "./cvresults/22PCAV3Prediction.csv")
write.table(misclassificationrate, "./cvresults/22misclassificationrate_V4.csv")
write.table(auc, "./cvresults/22auc_V4.csv")
write.table(sensitivity, "./cvresults/22sensitivity_V4.csv")
write.table(specificity, "./cvresults/22specificity_V4.csv")
# ====================================================================================