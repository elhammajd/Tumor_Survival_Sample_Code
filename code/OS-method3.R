...
# PCA MODEL with mean 
# ======================================================================
group6<- read.csv("./finalresultmethod3/groupfmodel6.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model6", col.names = TRUE)
...
# PCA MODEL with mean 
# ======================================================================
group7<- read.csv("./finalresultmethod3/groupfmodel7.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model7", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group8<- read.csv("./finalresultmethod3/groupfmodel8.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model8", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group9<- read.csv("./finalresultmethod3/groupfmodel9.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model9", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group11<- read.csv("./finalresultmethod3/groupfmodel11.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model11", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group12<- read.csv("./finalresultmethod3/groupfmodel12.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model12", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group16<- read.csv("./finalresultmethod3/groupfmodel16.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model16", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group17<- read.csv("./finalresultmethod3/groupfmodel17.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model17", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group18<- read.csv("./finalresultmethod3/groupfmodel18.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model18", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group22<- read.csv("./finalresultmethod3/groupfmodel22.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model22", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group23<- read.csv("./finalresultmethod3/groupfmodel23.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model23", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group31<- read.csv("./finalresultmethod3/groupfmodel31.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model31", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group32<- read.csv("./finalresultmethod3/groupfmodel32.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model32", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group34<- read.csv("./finalresultmethod3/groupfmodel34.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model34", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group35<- read.csv("./finalresultmethod3/groupfmodel35.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model35", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group37<- read.csv("./finalresultmethod3/groupfmodel37.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model37", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group41<- read.csv("./finalresultmethod3/groupfmodel41.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model41", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group42<- read.csv("./finalresultmethod3/groupfmodel42.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model42", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group53<- read.csv("./finalresultmethod3/groupfmodel53.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model53", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group54<- read.csv("./finalresultmethod3/groupfmodel54.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model54", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group55<- read.csv("./finalresultmethod3/groupfmodel55.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model55", col.names = FALSE)
...
# ======================================================================
# ======================================================================
group59<- read.csv("./finalresultmethod3/groupfmodel59.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model59", col.names = FALSE)
...
# PCA MODEL with mean 
# ======================================================================
group58<- read.csv("./finalresultmethod3/groupfmodel58.csv")
...
write.table(coxresults, file="./Osmethod3/coxmethod3.csv", append = TRUE, quote = FALSE, sep = "      ", row.names = "model58", col.names = FALSE)
...
survp58 <- ggsurvplot(ff, risk.table = FALSE, palette = 
                        c("#FF0066", "#AF6FDF"))
ggsave(file = "./Figures/surplotm3-model58.png", survp58$plot)
...
ggsave(file = "./Figures/surplotm3-risk-censor-model58.png", surv58$plot)
